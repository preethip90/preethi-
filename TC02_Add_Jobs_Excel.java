...
public class TC02_Add_Jobs_Excel {
	...
	static WebDriver driver;
	 ...
	 public Object[] myDataProvider() {
		...
		@DataProvider(name = "TC01_Add_JobsData")
		public static Object[][] Authentication1() throws Exception {
			
			ExcelApiTest4 T1 = new ExcelApiTest4();
			Object[][] testObjArray = T1.getTableArray("C://HTML Report//OrangeHRM6//TC01_Jobs78.xlsx", "Sheet1");
			System.out.println(testObjArray.length);
			return (testObjArray);
		}
	
  @Test(dataProvider="TC01_Add_JobsData")
  public void jobsAddTest(String TestURL,String USerName,
	  ...
	  TC02_Add_Jobs_Excel T1=new  TC02_Add_Jobs_Excel();
